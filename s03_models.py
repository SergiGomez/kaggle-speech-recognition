...
def create_model(fingerprint_input, model_settings, model_architecture,
  ...
  """
    ...
    elif model_architecture == 'cnn_tpool3':
        return create_tpool3_model(fingerprint_input, model_settings, is_training)
    else:
...
def create_tpool3_model(fingerprint_input, model_settings, is_training):
  ...
  fingerprint_4d = tf.reshape(fingerprint_input,
                              [-1, input_time_size, input_frequency_size, 1])
  first_filter_width = 15
  first_filter_height = 40
  first_filter_count = 25
  first_weights = tf.Variable(
      tf.truncated_normal(
          [first_filter_height, first_filter_width, 1, first_filter_count],
          stddev=0.01))
